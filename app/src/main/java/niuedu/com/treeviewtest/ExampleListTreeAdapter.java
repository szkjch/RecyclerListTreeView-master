        ...
        public GroupViewHolder(View itemView) {
            ...
            textViewTitle.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    Toast.makeText(view.getContext(),textViewTitle.getText(),Toast.LENGTH_SHORT).show();
                    int planePos = getAdapterPosition();
                    //通过这个索引值，获取到node数据
                    ListTree.TreeNode node = tree.getNodeByPlaneIndex(planePos);
                    Toast.makeText(view.getContext(),"mm"+tree.getNodePlaneIndex(node),Toast.LENGTH_SHORT).show();
