...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // ListTree.TreeNode groupNode1=tree.addNode(null,"特别关心", R.layout.contacts_group_item);
        ...
        List<ListTree.TreeNode> nodes_yct=new ArrayList<ListTree.TreeNode>();
        //ListTree.TreeNode mydata=new ListTree.TreeNode(this, "c", R.layout.contacts_group_item);
        for (int i=1;i<100;i++){
            nodes_yct.add(tree.addNode(null,"我的好友", R.layout.contacts_group_item));
        }
       ...
       // ListTree.TreeNode groupNode5=tree.addNode(null,"同学", R.layout.contacts_group_item);
        groupNode2.setShowExpandIcon(true);
        //层数测试
        ListTree.TreeNode parent=tree.addNode(groupNode2,"同学ee", R.layout.contacts_group_item);;
        for (int i=0;i<500;i++){
            parent=tree.addNode(parent,"同学", R.layout.contacts_group_item);

        }
        //yct自己写的第二层
        ListTree.TreeNode groupNode3=tree.addNode(groupNode2,"同学", R.layout.contacts_group_item);
        //第二层
        ExampleListTreeAdapter.ContactInfo contact;
        Bitmap bitmap= BitmapFactory.decodeResource(getResources(), R.drawable.port);
        contact = new ExampleListTreeAdapter.ContactInfo(bitmap,"晓晓","[在线]计算机学院");
        ListTree.TreeNode contactNode1=tree.addNode(groupNode3,contact,R.layout.contacts_contact_item);
       // ListTree.TreeNode contactNode2=tree.addNode(groupNode5,contact,R.layout.contacts_contact_item);
        ...
        contact=new ExampleListTreeAdapter.ContactInfo(bitmap,"浮歌","[离线]我没有状态");
        for (int i=1;i<100000;i++){
            contact=new ExampleListTreeAdapter.ContactInfo(bitmap,"浮歌"+i,"[离线]我没有状态");
            tree.addNode(groupNode3,contact,R.layout.contacts_contact_item);
        }
      ...
      //  tree.addNode(groupNode5,contact,R.layout.contacts_contact_item);
        ...
        //第三层
        bitmap = BitmapFactory.decodeResource(getResources(), R.drawable.port);
